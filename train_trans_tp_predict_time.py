...
parser = argparse.ArgumentParser(description='tranr_tp_time_predict')
...
args.checkpoint = "./checkpoint_"+args.data_process + "/transr_tp_time_predict/"+args.data_type+"/"+str(args.dim)+"_"+str(args.margin)+"_"+str(args.lr)+"/train"+".ckpt"
